...
from config.config import path_dir,url,username,password,opTrainGroupCust_config
from test_opTrainGroupCust.traingroup_config import *
...
class test_technology:
    ...
    def tech(self,url,username,password,carname):
        ...
        for i in opTrainGroupCust_config:
            try:
...
test_technology().tech(url,username,password,'0207')
