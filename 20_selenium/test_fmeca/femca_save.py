...
class Tech:
    ...
    def tech_analysis(self,url,username,password,modelName,remarks,select,start,end,car,fault,select_fault,time_sleep,wait_time):
...
Tech().tech_analysis(url,username,password,'1.16测试','','里程','0','100',car,fault_pattern,'交集',time_sleep,wait_time)