from config.config import path_dir,url,username,password,nhpp_config
...
time_sleep = 3
wait_time = 10
Tech().tech_nhpp_model(url,username,password,'1.16测试','1.16测试','2017-03-28','2018-03-12',car,time_sleep,wait_time)