from config.config import path_dir,url,username,password,incontrol_config
...
Tech().tech_analysis(url,username,password,'1.16测试','2017-02-01','2018-03-05','',car,time_sleep,wait_time)
