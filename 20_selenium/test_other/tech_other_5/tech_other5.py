from config.config import path_dir,url,username,password,maxRepairTime_config
...
class Tech:
    ...
    def tech_all_5(self,modelCode,url,username,password,time_sleep):
        ...
        try:
            ...
            Method(driver).switch_iframe(
                driver.find_element_by_xpath("//iframe[contains(@src,'/darams/a/calculator/maxRepairTime')]"))
        ...
        try:
            ...
            Method(driver).switch_iframe(driver.find_element_by_xpath(
                "//iframe[contains(@src,'/darams/a/tag/gridselect?url=%2Fdarams%2Fa%2Fcalculator%2FmaintenanceData%2FpopData%3FdataType%3DmaxRepairTime&fieldLabels=%E6%A8%A1%E5%9E%8B%E7%BC%96%E7%A0%81%7C%E6%A8%A1%E5%9E%8B%E5%90%8D%E7%A7%B0&fieldKeys=modelCode%7CmodelName&searchLabels=%E6%A8%A1%E5%9E%8B%E7%BC%96%E7%A0%81%7C%E6%A8%A1%E5%9E%8B%E5%90%8D%E7%A7%B0&searchKeys=modelCode%7CmodelName&isMultiSelected=false')]"))
            time.sleep(time_sleep)
        except Exception as e:
...
Tech().tech_all_5('X1',url,username,password,time_sleep)