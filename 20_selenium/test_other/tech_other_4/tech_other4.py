from config.config import path_dir,url,username,password,averageRepairtime_config
...
class Tech:
    ...
    def tech_all_4(self,modelCode,url,username,password,time_sleep):
        ...
        for i in averageRepairtime_config:
            try:
...
Tech().tech_all_4('X3',url,username,password,time_sleep)
