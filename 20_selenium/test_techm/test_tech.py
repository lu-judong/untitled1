...
from config.config import path_dir,url,username,password,tech_config
...
# car = {"E30": "0.2", "E32B": "0.8", "E25": "0.5", "E27": "0.7", "E11": "0.9"}
...
wait_time = 10
#
Tech().tech_analysis(url,username,password,'技术整改数据测试2',1,'','时间','2017-02-01','2017-12-01','2018-03-01',2,car,fault_object,'交集',fault1,time_sleep,wait_time)