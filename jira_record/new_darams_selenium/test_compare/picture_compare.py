...
class Compare:
    ...
    def picture(self,url,username,password):
        ...
        driver.find_element_by_xpath(
            "//a[contains(text(),\'{}\')]/../../td[8]/a[4]".format('111')).click()
        ...
        js = 'var aa = echarts.getInstanceByDom($("#moreModel")[0]);' \
             ...
             'jp.openDialogView ("", "/darams/a/mould/moreModel/skipTo?XValue=" + option.series[0].data[1][0]+ "&YValue=" + option.series[0].data[1][1] + "&confModelName=" + option.series[0].name + "&lineType=" + "关联故障" + "&confModelId=169b614379a2421cb7fb598744ab6403000&chartType=index","100%", "100%");'
        try:
        ...
        js1 = 'var aa = echarts.getInstanceByDom($("#moreModel")[0]);' \
             'var option = aa.getOption();' \
             'jp.openDialogView (\'\', "/darams/a/mould/moreModel/skipTo?XValue=" + option.series[0].data[1][0]+ "&YValue=" + option.series[0].data[1][1] + "&confModelName=" + option.series[0].name + "&lineType=" + "基本故障" + "&confModelId=169b614379a2421cb7fb598744ab6403000&chartType=index","100%", "100%");'
        try:
        ...
        js2 = 'var aa = echarts.getInstanceByDom($("#moreModel")[0]);' \
              'var option = aa.getOption();' \
              'jp.openDialogView (\'\', "/darams/a/mould/moreModel/skipTo?XValue=" + option.series[0].data[1][0]+ "&YValue=" + option.series[0].data[1][1] + "&confModelName=" + option.series[0].name + "&lineType=" + "安监故障" + "&confModelId=169b614379a2421cb7fb598744ab6403000&chartType=index","100%", "100%");'
        try:
        ...
        js3 = 'var aa = echarts.getInstanceByDom($("#moreModel")[0]);' \
              'var option = aa.getOption();' \
              'jp.openDialogView (\'\', "/darams/a/mould/moreModel/skipTo?XValue=" + option.series[0].data[1][0]+ "&YValue=" + option.series[0].data[1][1] + "&confModelName=" + option.series[0].name + "&lineType=" + "服务故障" + "&confModelId=169b614379a2421cb7fb598744ab6403000&chartType=index","100%", "100%");'
        try:
        ...
        js4 = 'var aa = echarts.getInstanceByDom($("#moreModel")[0]);' \
              'var option = aa.getOption();' \
              'jp.openDialogView (\'\', "/darams/a/mould/moreModel/skipTo?XValue=" + option.series[0].data[1][0]+ "&YValue=" + option.series[0].data[1][1] + "&confModelName=" + option.series[0].name + "&lineType=" + "非关联故障" + "&confModelId=169b614379a2421cb7fb598744ab6403000&chartType=index","100%", "100%");'
        try:
