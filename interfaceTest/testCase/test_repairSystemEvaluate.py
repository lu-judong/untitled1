...
from interfaceTest.testInput.test_repairSystemEvaluate_input.test_4_repairSystemEvaluate_charts import *


@ddt.ddt
class test_repairSystem(unittest.TestCase):
    ...
    # @ddt.file_data('{}/testInput/test_repairSystemEvaluate_input/test_2_repairSystemEvaluate.json'.format(path_dir))
    # def test_2_repairSystemEvaluate(self,modelId):
    #     """修程修制优化分析计算接口"""  # 说明测试用例的标题
    ...
    #
    #         write_sheet(path, '修程修制优化效果分析', '','','用户未登录','')
    #         self.assertEqual(3, 4)
    #     else:
    #         try:
    #             driver = self.driver
    #             driver.refresh()
    #             time.sleep(2)
    #             Method(driver).click('xpath', '//span[contains(text(),"维修规程优化效果分析")]')
    #             time.sleep(1)
    #
    #             # 计算接口
    #
    ...
    #             self.assertEqual(3, 4)
    #
    # @ddt.file_data('{}/testInput/test_repairSystemEvaluate_input/test_3_getModelStatus.json'.format(path_dir))
    ...
    @ddt.file_data('{}/testInput/test_repairSystemEvaluate_input/test_4_repairSystemEvaluate_charts.json'.format(path_dir))
    def test_4_repairSystemEvaluate_charts1(self, modelId):
        """修程修制图表1接口"""
        path = self.path
        if len(globals()["Authorization"]) == 0:
            ...
            if charts1_interface_status != 'non-existent':
                try:
                    ...
                    # 判断文件中是否存在
                    file = '{}/testFile/test_repairSystemEvaluate/test_repairSystemEvaluate_charts1/test_repairSystemEvaluate_charts1_{}.txt'.format(
                        path_dir, modelId)
                        ...
                        if not sz:
                            ...
                            if dict_fp == dict_ramscharts:
                                ...
                                if 'result' in dict_ramscharts.keys():
                                    ...
                                    write_sheet(path, '修程修制图表1接口', url, params,
    ...
    #
    @ddt.file_data('{}/testInput/test_repairSystemEvaluate_input/test_4_repairSystemEvaluate_charts.json'.format(path_dir))
    def test_5_repairSystemEvaluate_charts2(self, modelId):
        """修程修制图表2接口"""
        path = self.path
        if len(globals()["Authorization"]) == 0:
            write_sheet(path, '修程修制图表2接口', '', '', '用户未登录', '')
            ...
            if charts2_interface_status != 'non-existent':
                try:
                    ...
                    # 判断文件中是否存在
                    file = '{}/testFile/test_repairSystemEvaluate/test_repairSystemEvaluate_charts2/test_repairSystemEvaluate_charts2_{}.txt'.format(
                        path_dir, modelId)
                        ...
                        if not sz:
                            ...
                            if dict_fp == dict_ramscharts:
                                ...
                                if 'result' in dict_ramscharts.keys():
                                    ...
                                    write_sheet(path, '修程修制图表2接口', url, params,
                                                json.dumps(dict_ramscharts, ensure_ascii=False),
                                                json.dumps(result, ensure_ascii=False)[:2000])
                                else:
                                    write_sheet(path, '修程修制图表2接口', url, params,
    ...
    def test_6_repairSystemEvaluate_charts3(self, modelId):
        """修程修制图表3接口"""
        path = self.path
        if len(globals()["Authorization"]) == 0:
            write_sheet(path, '修程修制图表3接口', '', '', '用户未登录', '')
            ...
            if charts3_interface_status != 'non-existent':
                try:
                    ...
                    # 判断文件中是否存在
                    file = '{}/testFile/test_repairSystemEvaluate/test_repairSystemEvaluate_charts3/test_repairSystemEvaluate_charts3_{}.txt'.format(
                        path_dir, modelId)
                        ...
                        if not sz:
                            ...
                            if dict_fp == dict_ramscharts:
                                ...
                                if 'result' in dict_ramscharts.keys():
                                    ...
                                    write_sheet(path, '修程修制图表3接口', url, params,
                                                json.dumps(dict_ramscharts, ensure_ascii=False),
                                                json.dumps(result, ensure_ascii=False)[:2000])
                                else:
                                    write_sheet(path, '修程修制图表3接口', url, params,
    ...
    def test_7_repairSystemEvaluate_charts4(self, modelId):
        ...
        path = self.path
        if len(globals()["Authorization"]) == 0:
            write_sheet(path, '修程修制图表4接口', '', '', '用户未登录', '')
            ...
            if charts4_interface_status != 'non-existent':
                try:
                    ...
                    # 判断文件中是否存在
                    file = '{}/testFile/test_repairSystemEvaluate/test_repairSystemEvaluate_charts4/test_repairSystemEvaluate_charts4_{}.txt'.format(
                        path_dir, modelId)
                        ...
                        if not sz:
                            ...
                            if dict_fp == dict_ramscharts:
                                ...
                                if 'result' in dict_ramscharts.keys():
                                    ...
                                    write_sheet(path, '修程修制图表4接口', url, params,
                                                json.dumps(dict_ramscharts, ensure_ascii=False),
                                                json.dumps(result, ensure_ascii=False)[:2000])
                                else:
                                    write_sheet(path, '修程修制图表4接口', url, params,
    ...
    @ddt.file_data(
        '{}/testInput/test_repairSystemEvaluate_input/test_4_repairSystemEvaluate_charts.json'.format(path_dir))
    def test_8_repairSystemEvaluate_report(self, modelId):
        """修程修制报表接口"""
        path = self.path
        if len(globals()["Authorization"]) == 0:
            ...
            if report_interface_status != 'non-existent':
                try:
                    ...
                    # 判断报表接口第一个报表文件中是否存在
                    file = '{}/testFile/test_repairSystemEvaluate/test_repairSystemEvaluate_report/test_repairSystemEvaluate_report_{}.txt'.format(
                        path_dir, modelId)
                        ...
                        if not sz:
                            ...
                            if dict_fp == dict_ramscharts:
                                ...
                                if 'result' in dict_ramscharts.keys():
                                    ...
                                    write_sheet(path, '修程修制报表接口', url, params,
                                                json.dumps(dict_ramscharts, ensure_ascii=False),
                                                json.dumps(result, ensure_ascii=False)[:2000])
                                else:
                                    write_sheet(path, '修程修制报表接口', url, params,
                    ...
                    # 判断报表接口第二个报表文件中是否存在
                    file_2 = '{}/testFile/test_repairSystemEvaluate/test_repairSystemEvaluate_report/test_repairSystemEvaluate_report2_{}.txt'.format(
                        path_dir, modelId)
    ...
    @ddt.file_data(
        '{}/testInput/test_repairSystemEvaluate_input/test_4_repairSystemEvaluate_charts.json'.format(path_dir))
    def test_9_repairSystemEvaluate_middleValue(self, modelId):
        """修程修制中间值接口"""
        path = self.path
        if len(globals()["Authorization"]) == 0:
            write_sheet(path, '修程修制中间值接口', '', '', '用户未登录', '')
            ...
            if middleValue_interface_status != 'non-existent':
                try:
                    ...
                    # 判断报表接口第一个报表文件中是否存在
                    file = '{}/testFile/test_repairSystemEvaluate/test_repairSystemEvaluate_middleValue/test_repairSystemEvaluate_middleValue_{}.txt'.format(
                        path_dir, modelId)
                        ...
                        if not sz:
                            ...
                            if dict_fp == dict_ramscharts:
                                ...
                                if 'result' in dict_ramscharts.keys():
                                    ...
                                    write_sheet(path, '修程修制中间值接口', url, params,
                                                json.dumps(dict_ramscharts, ensure_ascii=False),
                                                json.dumps(result, ensure_ascii=False)[:2000])
                                else:
                                    write_sheet(path, '修程修制中间值接口', url, params,
...
if __name__ == '__main__':
    ...
    st.addTest(unittest.makeSuite(test_repairSystem))
    # unittest.main()
