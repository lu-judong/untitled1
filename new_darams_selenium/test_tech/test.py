...
def tech_test(url,username,password,modelName,value,value1):
    ...
    if driver.find_element_by_xpath('//*[@id="right_content"]/div/div[1]/div/p').text == tech_title[1]:
        print(tech_title[1]+'菜单名称与菜单页内容对应')
    else:
        print(tech_title[1] + '菜单名称与菜单页内容不对应')
...
tech_test(url,username,password,'上海测试',1,4)