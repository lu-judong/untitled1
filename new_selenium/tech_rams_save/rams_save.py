...
from new_selenium.tech_rams_save.rams_config import *
...
test_technology().tech(url,'admin','admin','111',1,'','时间','2017-02-03','2017-10-02',2,car,fault_object,'并集',fault1,time_sleep,wait_time)