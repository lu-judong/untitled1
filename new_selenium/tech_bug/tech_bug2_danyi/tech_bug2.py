...
from new_selenium.tech_bug.tech_bug2_danyi.bug_config import *
...
class Tech:
    ...
    def tech_analysis(self,url,modelCode):
        ...
        try:
            driver.find_element_by_xpath("//a[contains(text(),\'{}\')]/../../td[9]/a[4]".format(modelCode)).click()
        except NoSuchElementException as e:
            print('点击图表失败')
