...
class Check:
    ...
    def main1(self,car,date):
        ...
        if re.__len__() == 0:
            ...
            #                     if j[1] in Manhour['工具']['修复性费用'].keys():
            #                         pass
            #                     else:
            #                         Manhour['工具']['修复性费用'][j[1]] = j[4] * Decimal(d[j[1]][j[0]] / d1[j[1]])
            #                 else:
            #                     Manhour['工具']['修复性费用'] = {}
            #             else:
            #                 if '预防性费用' in Manhour['工具'].keys():
            #                     if j[1] in Manhour['工具']['预防性费用'].keys():
            #                         pass
            #                     else:
            #                         Manhour['工具']['预防性费用'][j[1]] = j[4] * Decimal(d[j[1]][j[0]] / d1[j[1]])
            #                 else:
            #                     Manhour['工具']['预防性费用'] = {}
            #         elif j[0] == '1':
            #             if j[3] is not None:
            #                 if '修复性费用' in Manhour['耗材'].keys():
            #                     if j[1] in Manhour['耗材']['修复性费用'].keys():
            #                         pass
            #                     else:
            #                         Manhour['耗材']['修复性费用'][j[1]] = j[4] * Decimal(d[j[1]][j[0]] / d1[j[1]])
            #                 else:
            #                     Manhour['耗材']['修复性费用'] = {}
            #             else:
            #                 if '预防性费用' in Manhour['耗材'].keys():
            #                     if j[1] in Manhour['耗材']['预防性费用'].keys():
            #                         pass
            #                     else:
            #                         Manhour['耗材']['预防性费用'][j[1]] = j[4] * Decimal(d[j[1]][j[0]] / d1[j[1]])
            #                 else:
            #                     Manhour['耗材']['预防性费用'] = {}
            #         elif j[0] == '2':
            #             if j[3] is not None:
            #                 if '修复性费用' in Manhour['备件'].keys():
            #                     if j[1] in Manhour['备件']['修复性费用'].keys():
            #                         pass
            #                     else:
            #                         Manhour['备件']['修复性费用'][j[1]] = j[4] * Decimal(d[j[1]][j[0]] / d1[j[1]])
            #                 else:
            #                     Manhour['备件']['修复性费用'] = {}
            #             else:
            #                 if '预防性费用' in Manhour['备件'].keys():
            #                     if j[1] in Manhour['备件']['预防性费用'].keys():
            #                         pass
            #                     else:
            #                         Manhour['备件']['预防性费用'][j[1]] = j[4] * Decimal(d[j[1]][j[0]] / d1[j[1]])
            #                 else:
            #                     Manhour['备件']['预防性费用'] = {}
            L2 = []
            L3 = []
        ...
        # L_sum = copy.deepcopy(Manhour_new)
...
Check().main({'E27':['2651'],'E28':['2216']},['2017-03-01','2017-04-01'])
# {'耗材': 3704733.2657244327, '备件': 3647764.891736408, '工具': 3791147.8425391586}